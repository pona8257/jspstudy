...
public class PapagoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 클라이언트 아이디, 시크릿
		String clientId = "Rs0ipJHLCwzB7tFjzmSf";
		String clientSecret = "fe9p4E4wjZ";
		...
		// Papago API로 보내야 하는 파라키터(source, target, text)
		...
		// Papago API로부터 번역 겨로가를 받아서 StringBulider에 저장
		...
		// StirngBuilder의 번역 결과를 client.html의 ajax로 보내기
