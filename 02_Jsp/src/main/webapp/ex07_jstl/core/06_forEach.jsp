...
<body>
	...
	<%
		...
		webtoonList.add(new Webtoon(415, "내시반청", 9.95, LocalDate.of(2022, 11, 23)));
		webtoonList.add(new Webtoon(415, "보통의 시선", 9.95, LocalDate.of(2022, 11, 30)));
		webtoonList.add(new Webtoon(415, "텐션", 9.95, LocalDate.of(2022, 12, 7)));
		webtoonList.add(new Webtoon(415, "HBLJ", 9.95, LocalDate.of(2022, 12, 14)));
